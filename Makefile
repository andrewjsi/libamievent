...
compile: $(OBJ) test_ami.o test_ami2.o ori_test.o amilog.o volcon.o meetmetalk.o
...
clean:
	rm -rf $(OBJ) test_ami.o test_ami2.o ori_test.o amilog.o test_ami test_ami2 ori_test core amilog volcon meetmetalk
